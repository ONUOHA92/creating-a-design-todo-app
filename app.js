...
newtodo.addEventListener('keyup', function (e) {
    if (e.key === 'Enter') {
        ...
        newItem.innerHTML = `<input type="checkbox" id="" class="checkbox notfinished"> 
        <label for=""></label><span>${newtodo.value}</span><button class="del-btn">
        <img src="images/icon-cross.svg" alt="" class="delete"></button>`;
